...
<head>
  ...
  <title>Data Mahasiswa | Data Tables</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url() ?>admin/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Data Mahasiswa</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url() ?>admin/dist/img/melati.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url() ?>admin/dist/img/melati.jpg" class="user-image" alt="User Image">
